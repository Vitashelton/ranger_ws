...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            package="rangermini_doorway_sim", executable="human_command_generator",
        ...
        Node(
            package="rangermini_doorway_sim", executable="kinematic_rangermini_sim",
        ...
        Node(
            package="rangermini_doorway_sim", executable="risk_cmd_filter",
            name="risk_cmd_filter", output="screen",
            parameters=[PathJoinSubstitution([pkg, "config", "doorway_params.yaml"])]
        ),
        Node(
            package="rangermini_doorway_sim", executable="doorway_markers",
