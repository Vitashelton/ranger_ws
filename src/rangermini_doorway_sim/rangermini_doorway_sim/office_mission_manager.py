...
class OfficeMissionManager(Node):
    def __init__(self):
        ...
        self.pose_client = self.create_client(
            SetEntityPose, "/world/corridor_902_904_906_908/set_pose")
    ...
    def on_mission(self, msg):
        ...
        spec.update({
            ...
            "llm_api_configured": bool(os.environ.get("DEEPSEEK_API_KEY")),
            "product": "EGA-OfficeNav",
        })
    ...
    def on_reset(self, _request, response):
        ...
        if self.pose_client.service_is_ready():
            ...
            request.entity = Entity(name="rangermini_2_0", type=Entity.MODEL)
            request.pose = Pose()
            request.pose.position.x = 1.2
            request.pose.position.y = 2.3
            request.pose.position.z = 0.01
